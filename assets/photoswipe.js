        ...
        var PhotoSwipe2 = function(template, UiClass, items, options) {
          ...
          var publicMethods = {
            ...
            init: function() {
              ...
              self.bg = framework.getChildByClass(template, "ap-pswp__bg");
              ...
              self.scrollWrap = framework.getChildByClass(template, "ap-pswp__scroll-wrap");
              self.container = framework.getChildByClass(self.scrollWrap, "ap-pswp__container");
              ...
              var rootClasses = "ap-pswp--open ";
              if (_options.mainClass) {
                rootClasses += _options.mainClass + " ";
              }
              if (_options.showHideOpacity) {
                rootClasses += "ap-pswp--animate_opacity ";
              }
            ...
            updateCurrZoomItem: function(emulateSetContent) {
              ...
              if (_itemHolders[1].el.children.length) {
                ...
                if (framework.hasClass(zoomElement, "ap-pswp__zoom-wrap")) {
          ...
          var _gestureStartTime, _gestureCheckSpeedTime, p = {}, p2 = {}, delta = {}, _currPoint = {}, _startPoint = {}, _currPointers = [], _startMainScrollPos = {}, _releaseAnimData, _posPoints = [], _tempPoint = {}, _isZoomingIn, _verticalDragInitiated, _oldAndroidTouchEndTimeout, _currZoomedItemIndex = 0, _centerPoint = _getEmptyPoint(), _lastReleaseTime = 0, _isDragging, _isMultitouch, _zoomStarted, _moved, _dragAnimFrame, _mainScrollShifted, _currentPoints, _isZooming, _currPointsDistance, _startPointsDistance, _currPanBounds, _mainScrollPos = _getEmptyPoint(), _currZoomElementStyle, _mainScrollAnimating, _midZoomPoint = _getEmptyPoint(), _currCenterPoint = _getEmptyPoint(), _direction, _isFirstMove, _opacityChanged, _bgOpacity, _wasOverInitialZoom, _isEqualPoints = function(p1, p22) {
            ...
            if (el.getAttribute("class") && el.getAttribute("class").indexOf("ap-pswp__scroll-wrap") > -1) {
              return false;
            }
            if (fn(el)) {
              return el;
          ...
          var _showOrHideTimeout, _showOrHide = function(item, img, out, completeFn) {
            ...
            var onComplete = function() {
              ...
              if (!out) {
                ...
                framework.addClass(template, "ap-pswp--animated-in");
            ...
            var startAnimation = function() {
              ...
              if (out && !closeWithRaf) {
                framework.removeClass(template, "ap-pswp--animated-in");
              }
              if (fadeEverything) {
                if (out) {
                  framework[(closeWithRaf ? "remove" : "add") + "Class"](template, "ap-pswp--animate_opacity");
                } else {
                  setTimeout(function() {
                    framework.addClass(template, "ap-pswp--animate_opacity");
                  }, 30);
                }
              }
          ...
          var _getItemAt, _getNumItems, _initialIsLoop, _getZeroBounds = function() {
            ...
            item.loading = true;
            item.loaded = false;
            var img = item.img = framework.createEl("ap-pswp__img", "img");
            var onComplete = function() {
              item.loading = false;
              item.loaded = true;
          ...
          _registerModule("Controller", {
            publicMethods: {
              ...
              setContent: function(holder, index) {
                ...
                holder.index = index;
                holder.item = item;
                var baseDiv = item.container = framework.createEl("ap-pswp__zoom-wrap");
                ...
                if (item.src && !item.loadError && !item.loaded) {
                  ...
                  if (framework.features.transform) {
                    var placeholderClassName = "ap-pswp__img ap-pswp__img--placeholder";
                    placeholderClassName += item.msrc ? "" : " ap-pswp__img--placeholder--blank";
                  ...
                  img = framework.createEl("ap-pswp__img", "img");
                  img.style.opacity = 1;
                  img.src = item.src;
          ...
          _registerModule("DesktopZoom", {
            publicMethods: {
              ...
              setupDesktopZoom: function(onInit) {
                ...
                var hasDraggingClass, updateZoomable = function() {
                  if (self.mouseZoomedIn) {
                    framework.removeClass(template, "ap-pswp--zoomed-in");
                    self.mouseZoomedIn = false;
                  }
                  if (_currZoomLevel < 1) {
                    framework.addClass(template, "ap-pswp--zoom-allowed");
                  } else {
                    framework.removeClass(template, "ap-pswp--zoom-allowed");
                  }
                  removeDraggingClass();
                }, removeDraggingClass = function() {
                  if (hasDraggingClass) {
                    framework.removeClass(template, "ap-pswp--dragging");
                ...
                _listen("pointerDown", function() {
                  if (self.mouseZoomedIn) {
                    ...
                    framework.addClass(template, "ap-pswp--dragging");
                  }
                });
              ...
              toggleDesktopZoom: function(centerPoint) {
                ...
                framework[(!zoomOut ? "add" : "remove") + "Class"](template, "ap-pswp--zoomed-in");
              }
            }
          });
